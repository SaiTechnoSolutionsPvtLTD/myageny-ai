    ...
    <div class="crm-page-body">
        <div class="crm-page-header">
            ...
            <div class="crm-header-actions">
                ...
                <a href="{{ route('hrms.masters.leave-types.create') }}" class="crm-btn crm-btn-primary">+ Add Leave Type</a>
            </div>
        </div>
        ...
        <div style="margin-bottom:16px;">
            <form method="GET" action="{{ route('hrms.masters.leave-types.index') }}" style="display:flex; gap:10px; flex-wrap:wrap;">
                ...
                @if(request()->filled('search'))
                    <a href="{{ route('hrms.masters.leave-types.index') }}" class="crm-btn crm-btn-ghost">Reset</a>
                @endif
            </form>
        </div>
                        ...
                        <td class="text-right">
                            <details class="crm-table-dropdown">
                                ...
                                <div class="crm-table-dropdown-menu">
                                    <a href="{{ route('hrms.masters.leave-types.edit', $leaveType) }}" class="crm-table-dropdown-item">
                                    ...
                                    <form action="{{ route('hrms.masters.leave-types.destroy', $leaveType) }}" method="POST" style="display:inline"
