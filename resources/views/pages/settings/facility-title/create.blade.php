@extends('layouts.app')
@section('title', 'Create Facility Title')
...
<main class="main-content">
    <div class="crm-page-body">
        <div class="crm-page-header">
            <div>
                <h2 class="crm-title">Create Facility Title</h2>
            ...
            <div class="crm-form-wrap">
                ...
                <div class="crm-form-body">
                    ...
                    <div>
                        ...
                        <textarea name="description" class="crm-textarea" placeholder="Optional facility title description">{{ old('description') }}</textarea>
                    </div>
                </div>
