...
<main class="main-content">
    <div class="crm-page-body">
        <div class="crm-page-header">
            <div>
                <h2 class="crm-title">Create Asset Category</h2>
            ...
            <div class="crm-form-wrap">
                ...
                <div class="crm-form-body">
                    ...
                    <div>
                        ...
                        <textarea name="description" class="crm-textarea" placeholder="Optional asset category description">{{ old('description') }}</textarea>
                    </div>
                </div>
