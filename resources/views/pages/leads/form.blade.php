...
<div class="lf-grid">
    ...
    <div class="lf-left">
                ...
                <div class="lf-row">
                    ...
                    <div class="lf-group">
                        ...
                        <div class="lf-iw">
                            ...
                            <svg class="lf-sel-caret" @if($isBranchLocked) style="opacity: 0.5;" @endif fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>
                        </div>
        ...
        <div class="lf-card">
            ...
            <div class="lf-submit">
                <button type="submit" class="lf-btn lf-btn-primary" style="width: 180px; justify-content: center;">
                        ...
                        <div class="lf-group {{ $isWideField ? 'span2' : '' }} custom-field-wrap"
                            ...
                            @elseif($field->field_type === 'file')
                                ...
                                @if(!empty($fieldValue) && is_string($fieldValue))
                                    @php
                                        $fileUrl = (str_starts_with($fieldValue, 'uploads/') || str_starts_with($fieldValue, 'http'))
                                            ? asset($fieldValue)
                                    ...
                                    <div style="margin-top:6px; font-size:12px; display:flex; align-items:center; gap:6px;">
                                        ...
                                        <a href="{{ $fileUrl }}" target="_blank" style="color:#60308c; font-weight:600; text-decoration:underline; display:inline-flex; align-items:center; gap:4px;">
