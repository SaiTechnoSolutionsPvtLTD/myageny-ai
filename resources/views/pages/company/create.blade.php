                ...
                <div class="cform-card-body">
                    ...
                    <div class="cform-group full" style="display:grid; grid-template-columns:repeat(2, minmax(0, 1fr)); gap:12px; background:#fafafa; padding:16px; border-radius:12px; border:1px solid #f0eef2;">
                        <label style="display:flex; align-items:center; gap:10px; cursor:pointer; font-size:13px; font-weight:600; color:#333;">
                            <input type="checkbox" name="show_price_request" value="1" {{ old('show_price_request', 1) ? 'checked' : '' }} style="width:18px; height:18px; accent-color:#fe5f04;">
                            Price Request Option
                        </label>

                        <label style="display:flex; align-items:center; gap:10px; cursor:pointer; font-size:13px; font-weight:600; color:#333;">
                            <input type="checkbox" name="show_production_update" value="1" {{ old('show_production_update', 1) ? 'checked' : '' }} style="width:18px; height:18px; accent-color:#fe5f04;">
                            Production Update
                        </label>

                        <label style="display:flex; align-items:center; gap:10px; cursor:pointer; font-size:13px; font-weight:600; color:#333;">
                            <input type="checkbox" name="show_approval_history" value="1" {{ old('show_approval_history', 1) ? 'checked' : '' }} style="width:18px; height:18px; accent-color:#fe5f04;">
                            Approval History
                        </label>

                        <label style="display:flex; align-items:center; gap:10px; cursor:pointer; font-size:13px; font-weight:600; color:#333;">
                            <input type="checkbox" name="show_cst_updates" value="1" {{ old('show_cst_updates', 1) ? 'checked' : '' }} style="width:18px; height:18px; accent-color:#fe5f04;">
                            CST Updates
                        </label>
                    </div>
                </div>
