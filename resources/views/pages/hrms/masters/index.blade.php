...
<div class="masters-page">
    ...
    <div class="masters-grid">
        ...
        @can('settings.manage')
        <a href="{{ route('settings.facility-titles.index') }}" class="masters-card facility-title">
        ...
        @can('settings.manage')
        <a href="{{ route('settings.asset-categories.index') }}" class="masters-card asset-category">
        ...
        @can('settings.manage')
        <a href="{{ route('settings.payroll.index') }}#permission-settings" class="masters-card attendance-rule">
            <div class="masters-card-icon attendance-rule">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
                    <circle cx="12" cy="12" r="9"></circle>
                    <path d="M12 7v5l3 2"></path>
        ...
        @can('settings.manage')
        <a href="{{ route('settings.payroll.index') }}#grace-time-settings" class="masters-card attendance-rule">
            <div class="masters-card-icon attendance-rule">
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        ...
        @can('settings.manage')
        <a href="{{ route('settings.payroll.index') }}" class="masters-card payroll">
