                ...
                <div class="eob-show-card">
                    ...
                    <div class="eob-card-body">
                        <div class="eob-show-grid">
                            ...
                            <div class="eob-show-item"><div class="eob-show-label">PF Employee Contribution (12%)</div><div class="eob-show-value">{{ $employee->pf_employee_contribution !== null ? number_format((float) $employee->pf_employee_contribution, 2) : 'N/A' }}</div></div>
                            <div class="eob-show-item"><div class="eob-show-label">PF Employer Contribution (13%)</div><div class="eob-show-value">{{ $employee->pf_employer_contribution !== null ? number_format((float) $employee->pf_employer_contribution, 2) : 'N/A' }}</div></div>
                            ...
                            <div class="eob-show-item"><div class="eob-show-label">ESI Employee Contribution (0.75%)</div><div class="eob-show-value">{{ $employee->esi_employee_contribution !== null ? number_format((float) $employee->esi_employee_contribution, 2) : 'N/A' }}</div></div>
                            <div class="eob-show-item"><div class="eob-show-label">ESI Employer Contribution (3.25%)</div><div class="eob-show-value">{{ $employee->esi_employer_contribution !== null ? number_format((float) $employee->esi_employer_contribution, 2) : 'N/A' }}</div></div>
