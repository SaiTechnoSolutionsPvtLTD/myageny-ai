...
<div class="masters-page">
    ...
    <div class="masters-grid">
        ...
        <a href="{{ route('masters.lead-statuses.index') }}" class="masters-card status">
        ...
        <a href="{{ route('masters.lead-sources.index') }}" class="masters-card source">
            <div class="masters-card-body">
        ...
        <a href="{{ route('masters.outcome-categories.index') }}" class="masters-card outcome">
            <div class="masters-card-body">
        ...
        <a href="{{ route('masters.outcome-sub-categories.index') }}" class="masters-card subcategory">
            <div class="masters-card-body">
        ...
        <a href="{{ route('masters.product-category.index') }}" class="masters-card product-category">
            <div class="masters-card-body">
        ...
        <a href="{{ route('masters.product-attribute.index') }}" class="masters-card product-subcategory">
            <div class="masters-card-body">
