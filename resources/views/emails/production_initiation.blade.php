...
<head>
    <meta charset="utf-8">
    <title>New Production Initiation</title>
</head>
    ...
    <div style="max-width: 680px; margin: 0 auto; background-color: #ffffff; border-radius: 14px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); border: 1px solid #e5e7eb;">
        ...
        <div style="background: linear-gradient(135deg, #059669 0%, #10b981 100%); padding: 26px 32px; color: #ffffff;">
            <div style="display: flex; align-items: center; justify-content: space-between;">
                <div>
                    <h2 style="margin: 0; font-size: 22px; font-weight: 800; letter-spacing: 0.5px;">🚀 Moved to Production</h2>
        ...
        <div style="padding: 30px;">
            <p style="font-size: 15px; margin-top: 0; color: #111827;">Hello Customer Success Team,</p>
            <p style="font-size: 14px; color: #4b5563; line-height: 1.6; margin-bottom: 24px;">
                A product has been successfully moved to production by <strong>{{ $initiatedBy?->name ?? 'System User' }}</strong> ({{ $initiatedBy?->email }}). Below are the full details:
            </p>
            ...
            <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 12px; padding: 18px 20px; margin-bottom: 24px;">
                ...
                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 4px 0; color: #0f172a;">{{ $lead?->email ?: 'N/A' }}</td>
                    </tr>
                </table>
            </div>
            ...
            <div style="background-color: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 12px; padding: 18px 20px; margin-bottom: 24px;">
                <h4 style="margin: 0 0 12px; font-size: 13px; font-weight: 800; color: #15803d; text-transform: uppercase; letter-spacing: 0.5px;">📦 Production Product Details</h4>
                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
                    <tr>
                    ...
                    <tr>
                        <td style="padding: 4px 0; color: #166534; font-weight: 600;">UI Available:</td>
                        <td style="padding: 4px 0; color: #0f172a;">{{ $initiation->ui_available ? 'Yes' : 'No' }}</td>
                    </tr>
            ...
            <div style="background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; padding: 18px 20px; margin-bottom: 24px;">
                <h4 style="margin: 0 0 12px; font-size: 13px; font-weight: 800; color: #475569; text-transform: uppercase; letter-spacing: 0.5px;">⚙️ Custom Form Data</h4>
                <table style="width: 100%; border-collapse: collapse; font-size: 13px;">
