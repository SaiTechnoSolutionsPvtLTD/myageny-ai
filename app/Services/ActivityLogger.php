...
class ActivityLogger
{
    ...
    public static function logPayment(
        ...
        $properties = array_merge([
            ...
            'payment_type'     => $paymentData instanceof \Illuminate\Database\Eloquent\Model ? $paymentData->payment_type : ($paymentData['payment_type'] ?? null),
            'is_tds_deducted'  => $paymentData instanceof \Illuminate\Database\Eloquent\Model ? (bool)$paymentData->is_tds_deducted : (bool)($paymentData['is_tds_deducted'] ?? false),
            'tds_percentage'   => $paymentData instanceof \Illuminate\Database\Eloquent\Model ? $paymentData->tds_percentage : ($paymentData['tds_percentage'] ?? null),
            'tds_amount'       => $paymentData instanceof \Illuminate\Database\Eloquent\Model ? $paymentData->tds_amount : ($paymentData['tds_amount'] ?? null),
            'after_tds_amount' => $paymentData instanceof \Illuminate\Database\Eloquent\Model ? $paymentData->after_tds_amount : ($paymentData['after_tds_amount'] ?? null),
